...
function crossover(parent1::Individual, parent2::Individual, instance::ProblemInstance, penalty_cost::Float64=350.0)::Tuple{Individual, Individual}
    ...
    for patient in route2
        ...
        insert_to_best_neighbour!(patient, child1, instance, penalty_cost)
        # insert_to_closest_neighbour!(patient, child1, instance)
    end
    for patient in route1
        # insert_to_best_neighbour!(patient, child2, instance, fitness_cache, penalty_cost)
        insert_to_best_neighbour!(patient, child2, instance, penalty_cost)
        #insert_to_closest_neighbour!(patient, child2, instance)
    end
